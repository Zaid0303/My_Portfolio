...
<section id="hero" class="d-flex flex-column justify-content-center align-items-center">
  <div class="hero-container" data-aos="fade-in">
    <h1>Muhammad Zaid</h1>
    <p>I'm <span class="typed" data-typed-items="UI/UX Designer, Frontend Developer, Backend Developer"></span></p>
  </div>
</section>
<!-- End Hero -->
          ...
          <div class="row">
            <div class="col-lg-6">
              <ul>
                ...
                <li><i class="bi bi-chevron-right"></i> <strong>Phone:</strong> <span>+92 3185897526</span></li>
            ...
            <div class="col-lg-6">
              <ul>
                ...
                <li><i class="bi bi-chevron-right"></i> <strong>Email:</strong> <span>zaid123aptech@gmail.com</span></li>
      ...
      <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-app">
          <div class="portfolio-wrap">
            <img src="img/portfolio/html-css1.png" class="img-fluid" alt="">
            <div class="portfolio-links">
              <a href="img/portfolio/html-css1.png" data-gallery="portfolioGallery" class="portfolio-lightbox"
                title="Simplon's Beauty Care Project"><i class="bx bx-plus"></i></a>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-app">
          <div class="portfolio-wrap">
            <img src="img/portfolio/html-css.png" class="img-fluid" alt="">
            <div class="portfolio-links">
              <a href="img/portfolio/html-css.png" data-gallery="portfolioGallery" class="portfolio-lightbox"
                title="Streamease Movie Project"><i class="bx bx-plus"></i></a>
              <a href="portfolio-details.php" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-card">
          <div class="portfolio-wrap">
            <img src="img/portfolio/core-php.png" class="img-fluid" alt="">
            <div class="portfolio-links">
              <a href="img/portfolio/core-php.png" data-gallery="portfolioGallery" class="portfolio-lightbox"
                title="Sound Porject"><i class="bx bx-plus"></i></a>
              <a href="portfolio-details.php" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-5 d-flex align-items-stretch">
          <div class="info">
            <div class="address">
              ...
              <h4>Location:</h4>
              <p>2B/31 Nazimabad No:2 Karachi, Pakistan</p>
            </div>

            <div class="email">
              <i class="bi bi-envelope"></i>
              <h4>Email:</h4>
              <p>zaid123aptech@gmail.com</p>
            </div>
            ...
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1181.4735822209102!2d67.03246561119576!3d24.906849046655694!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3eb33fbaa6bce011%3A0xf1acbfa75618bfee!2sJamia%20Masjid%20Nazimabad%20No.2!5e0!3m2!1sen!2s!4v1710162933546!5m2!1sen!2s"
